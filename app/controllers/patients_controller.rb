class PatientsController < ApplicationController
  ...
  private
    ...
    def patient_params
      params.require(:patient).permit(:v_date, :street, :city, :state, :zip, :cell, :home, :work, :email, :height, :weight, :m_stat, :occup, :company, :referred, :comp1, :comp2, :comp3, :d_onset, :pain_scale, :diag_given, :aq_b4, :di_list, :o_dis, :last_prd, :preg, :preg_wks)
    end
end
